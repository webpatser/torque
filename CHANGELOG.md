...
### Fixed
- **Dashboard works under a Content-Security-Policy without `'unsafe-eval'`.** The chrome (refresh popover, theme and sidebar toggles, copy button, row links) no longer uses Alpine expressions, which Alpine evaluates with `new Function`; a nonce'd vanilla script drives them instead. Under such a policy the popover was stuck open, both theme icons showed and clicks did nothing.
- **A new master clears a `drain:<pid>` pause key whose master is no longer running, instead of honouring it for the rest of its TTL** (with `drain_grace_seconds` at 7200 that parked the fleet for two hours after a killed reload). A drain pause belongs to the one master that wrote it; when that PID is gone (killed by the supervisor, OOM, hard exit) the pause has no owner, so the next master deletes it at boot and logs `Cleared stale drain pause left by master PID N (not running)`. The delete is a compare-and-delete on the exact value, only ever touches `drain:<pid>` values, and never a deliberate `torque:pause` (TTL-less, an operator resumes it). `torque:status` now names the reason while paused: manual, a drain from a live master, or a drain whose master is gone.
...
[0.16.6]: https://github.com/webpatser/torque/compare/v0.16.5...v0.16.6
[0.16.5]: https://github.com/webpatser/torque/compare/v0.16.4...v0.16.5
[0.16.4]: https://github.com/webpatser/torque/compare/v0.16.3...v0.16.4
[0.16.3]: https://github.com/webpatser/torque/compare/v0.16.2...v0.16.3
[0.16.2]: https://github.com/webpatser/torque/compare/v0.16.1...v0.16.2
[0.16.1]: https://github.com/webpatser/torque/compare/v0.16.0...v0.16.1
[0.16.0]: https://github.com/webpatser/torque/compare/v0.15.0...v0.16.0
[0.15.0]: https://github.com/webpatser/torque/compare/v0.14.5...v0.15.0
[0.14.5]: https://github.com/webpatser/torque/compare/v0.14.0...v0.14.5
[0.14.0]: https://github.com/webpatser/torque/compare/v0.13.0...v0.14.0
[0.13.0]: https://github.com/webpatser/torque/compare/v0.12.0...v0.13.0
[0.12.0]: https://github.com/webpatser/torque/compare/v0.11.0...v0.12.0
[0.11.0]: https://github.com/webpatser/torque/compare/v0.10.2...v0.11.0
[0.10.2]: https://github.com/webpatser/torque/compare/v0.10.1...v0.10.2
[0.10.1]: https://github.com/webpatser/torque/compare/v0.10.0...v0.10.1
[0.10.0]: https://github.com/webpatser/torque/compare/v0.9.0...v0.10.0
[0.9.0]: https://github.com/webpatser/torque/compare/v0.8.0...v0.9.0
[0.8.0]: https://github.com/webpatser/torque/compare/v0.7.2...v0.8.0
[0.7.2]: https://github.com/webpatser/torque/compare/v0.7.1...v0.7.2
[0.7.1]: https://github.com/webpatser/torque/compare/v0.7.0...v0.7.1
[0.7.0]: https://github.com/webpatser/torque/compare/v0.6.0...v0.7.0
